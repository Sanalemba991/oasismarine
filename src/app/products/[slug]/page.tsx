...
import Banner from "./History.png";
import {
  ArrowLeftIcon,
  FunnelIcon,
  Squares2X2Icon,
...
export default function DynamicCategorySubcategoryPage({
  params,
}: {
                        ...
                        >
                          ...
                          <div className="absolute top-3 right-3 flex flex-col gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                            <motion.button
                              ...
                              whileTap={{ scale: 0.9 }}
                              className="p-2 bg-white/90 backdrop-blur-sm rounded-full text-gray-600 hover:text-red-500 transition-colors shadow-lg"
                            >
