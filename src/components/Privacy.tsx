        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Unsubscribe from promotional communications</p>
                </div>
              </div>
            </div>
          ...
          <section className="border-t pt-8">
            ...
            <div className="bg-blue-50 p-6 rounded-lg">
              <h3 className="font-semibold text-gray-900 mb-4">Oasis Marine Trading L.L.C</h3>
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <MapPin className="w-5 h-5 text-blue-600 mt-0.5 flex-shrink-0" />
                  <div>
                    <p className="text-gray-700">5 – Street 2 11th St – Al Qusais</p>
                    <p className="text-gray-700">Dubai – United Arab Emirates</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <Phone className="w-5 h-5 text-blue-600 flex-shrink-0" />
                  <a href="tel:+971505483364" className="text-gray-700 hover:text-blue-600">
                    +971 505483364
                  </a>
                </div>
                <div className="flex items-center gap-3">
                  <Mail className="w-5 h-5 text-blue-600 flex-shrink-0" />
                  <a href="mailto:sales@oasismarineuae.com" className="text-gray-700 hover:text-blue-600">
